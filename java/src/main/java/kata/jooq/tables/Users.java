...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Integer> IS_ACTIVE = createField(DSL.name("is_active"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>users.location</code>.
     */
    public final TableField<UsersRecord, String> LOCATION = createField(DSL.name("location"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>users.preferences</code>.
     */
    public final TableField<UsersRecord, String> PREFERENCES = createField(DSL.name("preferences"), SQLDataType.CLOB, this, "");
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USERS__UK_USERS_1_15067867);
    }
